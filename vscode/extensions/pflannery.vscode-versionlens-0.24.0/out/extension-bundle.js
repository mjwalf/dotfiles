...
System.register("providers/pub/config", [], function (exports_2, context_2) {
    "use strict";
    var pubDefaultDependencyProperties;
    var __moduleName = context_2 && context_2.id;
    return {
        setters: [],
        execute: function () {
            exports_2("pubDefaultDependencyProperties", pubDefaultDependencyProperties = [
                "dependencies",
                "dev_dependencies"
            ]);
        }
...
System.register("providers/dotnet/config", [], function (exports_4, context_4) {
    "use strict";
    var dotnetCSProjDefaultDependencyProperties, dotnetDefaultNuGetFeeds;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_4("dotnetDefaultNuGetFeeds", dotnetDefaultNuGetFeeds = [
...
System.register("common/appContrib", ["providers/npm/config", "providers/pub/config", "providers/dub/config", "providers/dotnet/config", "providers/maven/config"], function (exports_6, context_6) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_6("default", new /** @class */ (function () {
                ...
                Object.defineProperty(AppContribution.prototype, "pubDependencyProperties", {
                    get: function () {
                        var config = workspace.getConfiguration('versionlens');
                        return config.get("pub.dependencyProperties", config_2.pubDefaultDependencyProperties);
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                Object.defineProperty(AppContribution.prototype, "dotnetNuGetFeeds", {
                    get: function () {
                        var config = workspace.getConfiguration('versionlens');
                        return config.get("dotnet.nugetFeeds", config_4.dotnetDefaultNuGetFeeds);
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AppContribution.prototype, "dotnetIncludePrerelease", {
                    get: function () {
                        var config = workspace.getConfiguration('versionlens');
...
System.register("providers/dub/dubAPI", [], function (exports_25, context_25) {
    "use strict";
    ...
    exports_25("dubGetPackageLatest", dubGetPackageLatest);
    ...
    exports_25("readDubSelections", readDubSelections);
    return {
        setters: [],
        execute: function () {
            /*---------------------------------------------------------------------------------------------
...
System.register("providers/dub/dubDependencyParser", ["common/dependencyParser"], function (exports_26, context_26) {
    "use strict";
    var dependencyParser_4;
    var __moduleName = context_26 && context_26.id;
    function findNodesInJsonContent(jsonContent, filterProperties) {
        var rootNode = dependencyParser_4.findRootNode(jsonContent);
        if (!rootNode)
            return [];
        var dependencyNodes = dependencyParser_4.extractDependencyNodes(rootNode, filterProperties);
        var subObjectNodes = extractSubPackageDependencyNodes(rootNode);
        dependencyNodes.push.apply(dependencyNodes, subObjectNodes);
        return dependencyNodes;
    }
    exports_26("findNodesInJsonContent", findNodesInJsonContent);
            ...
            if (childNode.key.value == "subPackages") {
                childNode.value.items.forEach(function (subPackage) {
                    if (subPackage.type == "object") {
                        subPackage.properties.forEach(function (property) { return collector.push(dependencyParser_4.createDependencyNode(property)); });
                    }
                });
            }
        });
    ...
    exports_26("extractSubPackageDependencyNodes", extractSubPackageDependencyNodes);
    return {
        setters: [
...
System.register("providers/dub/dubCodeLensProvider", ["commands/factory", "common/appContrib", "common/codeLensGeneration", "common/appSettings", "common/utils", "common/dependencyParser", "providers/abstractCodeLensProvider", "providers/dub/dubAPI", "providers/dub/dubDependencyParser", "editor/decorations"], function (exports_27, context_27) {
    "use strict";
    var CommandFactory, appContrib_6, codeLensGeneration_3, appSettings_7, utils_5, dependencyParser_5, abstractCodeLensProvider_2, dubAPI_1, dubDependencyParser_1, decorations_3, path, DubCodeLensProvider;
        ...
        execute: function () {
            ...
            DubCodeLensProvider = /** @class */ (function (_super) {
                ...
                DubCodeLensProvider.prototype.provideCodeLenses = function (document, token) {
                    if (appSettings_7.default.showVersionLenses === false)
                        return [];
                    this._documentPath = path.dirname(document.uri.fsPath);
                    var dependencyNodes = dubDependencyParser_1.findNodesInJsonContent(document.getText(), appContrib_6.default.dubDependencyProperties);
                    var packageCollection = dependencyParser_5.parseDependencyNodes(dependencyNodes, appContrib_6.default);
                    if (packageCollection.length === 0)
                        return [];
                    appSettings_7.default.inProgress = true;
                    return this.updateOutdated()
                        .then(function (_) {
                        appSettings_7.default.inProgress = false;
                ...
                DubCodeLensProvider.prototype.evaluateCodeLens = function (codeLens) {
                    ...
                    if (codeLens.package.version === '~master')
                        return CommandFactory.createMatchesLatestVersionCommand(codeLens);
                    // generate decoration
                    if (appSettings_7.default.showDependencyStatuses)
                        this.generateDecoration(codeLens);
                ...
                DubCodeLensProvider.prototype.generateDecoration = function (codeLens) {
                    ...
                    if (utils_5.formatWithExistingLeading(currentPackageVersion, currentVersion) == currentPackageVersion) {
            ...
            exports_27("DubCodeLensProvider", DubCodeLensProvider);
        }
    };
});
System.register("providers/dotnet/dotnetDependencyParser", [], function (exports_28, context_28) {
    "use strict";
    var xmldoc, Range;
    ...
    exports_28("findNodesInXmlContent", findNodesInXmlContent);
    ...
    exports_28("extractDependencyNodes", extractDependencyNodes);
...
System.register("providers/dotnet/nugetClient", ["common/appContrib"], function (exports_29, context_29) {
    "use strict";
    var appContrib_7, semver;
    var __moduleName = context_29 && context_29.id;
    function nugetGetPackageVersions(packageName) {
        var httpRequest = require('request-light');
        var promises = appContrib_7.default.dotnetNuGetFeeds.map(function (feed) {
            var queryUrl = feed + "?id=" + packageName + "&prerelease=" + appContrib_7.default.dotnetIncludePrerelease + "&semVerLevel=2.0.0";
            return new Promise(function (resolve, reject) {
                httpRequest.xhr({ url: queryUrl })
                    .then(function (response) {
                    if (response.status != 200) {
        ...
        return Promise.all(promises.map(function (p) {
            return p.then(function (result) { return Promise.resolve(result); }, function (error) { return Promise.resolve(error); });
        })).then(function (results) {
            var dataResults = results.filter(function (result) { return Array.isArray(result); }).sort(function (a, b) { return semver.gt(a[0], b[0]); }); // Filter arrays and sort by first/highest version
            if (dataResults.length === 0)
                return Promise.reject(results[0]); // If no arrays, no successful resolves
            return Promise.resolve(dataResults[0]);
        }, function (_) { return Promise.reject({ status: 404 }); });
    }
    exports_29("nugetGetPackageVersions", nugetGetPackageVersions);
    return {
        setters: [
...
System.register("providers/dotnet/dotnetUtils", [], function (exports_30, context_30) {
    "use strict";
    ...
    exports_30("expandShortVersion", expandShortVersion);
    ...
    exports_30("parseVersionSpec", parseVersionSpec);
    ...
    exports_30("convertNugetToNodeRange", convertNugetToNodeRange);
    return {
        setters: [],
        execute: function () {
        }
...
System.register("providers/dotnet/dotnetPackageParser", ["common/appSettings", "common/packageGeneration", "providers/dotnet/nugetClient", "providers/dotnet/dotnetUtils", "common/versionUtils"], function (exports_31, context_31) {
    "use strict";
    var appSettings_8, PackageFactory, nugetClient_js_1, dotnetUtils_js_1, versionUtils_2;
    ...
    function dotnetPackageParser(name, requestedVersion, appContrib) {
        ...
        return nugetClient_js_1.nugetGetPackageVersions(name)
            ...
            var satisfiesEntry = extractedTags[0];
            var filteredTags = extractedTags;
            if (appSettings_8.default.showTaggedVersions === false) //  && extractedTags.length > 2
                // only show 'satisfies' and 'latest' entries when showTaggedVersions is false
                filteredTags = [
                    satisfiesEntry
                ].concat((satisfiesEntry.isLatestVersion ? [] : extractedTags[1]));
            ...
            return filteredTags.map(function (tag, index) {
                ...
                return PackageFactory.createPackage(name, nodeRequestedRange, packageInfo);
            });
        })
            .catch(function (error) {
    ...
    exports_31("dotnetPackageParser", dotnetPackageParser);
    return {
        setters: [
        ...
        execute: function () {
            DotNetCodeLensProvider = /** @class */ (function (_super) {
                ...
                DotNetCodeLensProvider.prototype.provideCodeLenses = function (document, token) {
                    ...
                    var packageCollection = dependencyParser_6.parseDependencyNodes(dependencyNodes, appContrib_8.default, dotnetPackageParser_js_1.dotnetPackageParser);
            ...
            exports_32("DotNetCodeLensProvider", DotNetCodeLensProvider);
        }
    };
});
System.register("providers/maven/mavenDependencyParser", [], function (exports_33, context_33) {
    "use strict";
    var xmldoc, window;
    ...
    exports_33("findNodesInXmlContent", findNodesInXmlContent);
    function extractDependencyNodes(rootNode, document, filterProperties) {
        var collector = [];
        rootNode.eachChild(function (group) {
            switch (group.name) {
    ...
    exports_33("extractDependencyNodes", extractDependencyNodes);
...
System.register("providers/maven/mavenAPI", [], function (exports_34, context_34) {
    "use strict";
    var window, promisify, fs, xmldoc, exec, httpRequest, MAVEN_CENTRAL, repositories;
    ...
    function loadMavenRepositories() {
        ...
        return Promise.all([
            exec('mvn help:effective-settings').then(function (response) {
                var regex = /<\?xml(.+\r?\n?)+\/settings>/gm;
                var xmlString = regex.exec(response.stdout.toString())[0];
                var local_repositories = [];
                var xml = new xmldoc.XmlDocument(xmlString);
                var localRepository = xml.descendantWithPath("localRepository");
    ...
    exports_34("loadMavenRepositories", loadMavenRepositories);
    function mavenGetPackageVersions(packageName) {
        ...
        return Promise.all(repositories.map(function (repository) {
            ...
            if (repository.startsWith("file://")) {
                var queryUrl_1 = "" + repository.replace("file://", "") + search + "/maven-metadata-local.xml";
                return new Promise(function (resolve, reject) {
                    fs.readFile(queryUrl_1, function (err, data) {
                        console.log(err);
                        console.log(data);
                        if (!err) {
                            var xmlRootNode = new xmldoc.XmlDocument(data);
                            ...
                            xmlVersionsList.forEach(function (xmlVersionNode) {
                                versions_1.push(xmlVersionNode.val);
                            });
                            return resolve(versions_1);
                        }
                        else {
                            return resolve([]);
                        }
    ...
    exports_34("mavenGetPackageVersions", mavenGetPackageVersions);
    return {
        setters: [],
        execute: function () {
            window = require('vscode').window;
...
System.register("providers/maven/versionUtils", [], function (exports_35, context_35) {
    "use strict";
    ...
    exports_35("buildMapFromVersionList", buildMapFromVersionList);
    ...
    exports_35("buildTagsFromVersionMap", buildTagsFromVersionMap);
    function parseVersion(version) {
        if (!version) {
            return [];
        }
    ...
    exports_35("parseVersion", parseVersion);
    ...
    exports_35("weightedQualifier", weightedQualifier);
    ...
    exports_35("compareVersions", compareVersions);
...
System.register("providers/maven/mavenPackageParser", ["providers/maven/mavenAPI", "common/appSettings", "common/packageGeneration", "providers/maven/versionUtils"], function (exports_36, context_36) {
    "use strict";
    var mavenAPI_1, appSettings_10, PackageFactory, versionUtils_3;
    ...
    function mavenPackageParser(name, requestedVersion, appContrib) {
        ...
        return mavenAPI_1.mavenGetPackageVersions(name)
            ...
            var filteredTags = extractedTags;
            if (appSettings_10.default.showTaggedVersions === false) {
    ...
    exports_36("mavenPackageParser", mavenPackageParser);
    return {
        setters: [
...
System.register("providers/maven/mavenCodeLensProvider", ["commands/factory", "common/appSettings", "common/appContrib", "common/dependencyParser", "common/codeLensGeneration", "providers/abstractCodeLensProvider", "providers/maven/mavenDependencyParser", "providers/maven/mavenPackageParser", "providers/maven/mavenAPI"], function (exports_37, context_37) {
    "use strict";
    var CommandFactory, appSettings_11, appContrib_9, dependencyParser_7, codeLensGeneration_5, abstractCodeLensProvider_4, mavenDependencyParser_1, mavenPackageParser_1, mavenAPI_2, MavenCodeLensProvider;
    ...
    return {
        setters: [
            ...
            function (mavenAPI_2_1) {
                mavenAPI_2 = mavenAPI_2_1;
            }
        ],
        execute: function () {
            MavenCodeLensProvider = /** @class */ (function (_super) {
                ...
                MavenCodeLensProvider.prototype.provideCodeLenses = function (document, token) {
                    if (appSettings_11.default.showVersionLenses === false)
                        return [];
                    return mavenAPI_2.loadMavenRepositories().then(function (_) {
                        ...
                        var packageCollection = dependencyParser_7.parseDependencyNodes(dependencyNodes, appContrib_9.default, mavenPackageParser_1.mavenPackageParser);
            ...
            exports_37("MavenCodeLensProvider", MavenCodeLensProvider);
        }
    };
});
System.register("providers/pub/pubDependencyParser", [], function (exports_38, context_38) {
    "use strict";
    var Range, YAML, jsonParser;
    var __moduleName = context_38 && context_38.id;
    function findNodesInYamlContent(document, filterProperties) {
        var data = document.getText();
        var pubspec = YAML.parse(data);
        var content = JSON.stringify(pubspec);
        var json = JSON.parse(content);
        var rootNode = findRootNode(content);
        if (!rootNode) {
            return [];
        }
        var dependencyNodes = extractDependencyNodes(rootNode, filterProperties, data);
        return dependencyNodes;
    }
    exports_38("findNodesInYamlContent", findNodesInYamlContent);
    function collectChildDependencyNodes(nodes, collector, content) {
        nodes.forEach(function (node) {
            var packageString = node.value.location + ": " + node.value.getValue();
    ...
    exports_38("findRootNode", findRootNode);
    function extractDependencyNodes(rootNode, filterList, content, collector) {
        if (collector === void 0) { collector = []; }
        rootNode.getChildNodes().forEach(function (node) {
            // check if this node should be processed
            if (filterList.includes(node.key.value) === false) {
                return;
            }
    ...
    exports_38("extractDependencyNodes", extractDependencyNodes);
    function parseDependencyNodes(dependencyNodes, appContrib, customPackageParser) {
        if (customPackageParser === void 0) { customPackageParser = null; }
        var collector = [];
        dependencyNodes.forEach(function (node) {
    ...
    exports_38("parseDependencyNodes", parseDependencyNodes);
    function createDependencyNode(node, replaceInfo, content) {
        if (!replaceInfo) {
            replaceInfo = {
                start: node.value.start + 1,
                end: node.value.end - 1
    ...
    exports_38("createDependencyNode", createDependencyNode);
    return {
        setters: [],
        execute: function () {
            /*---------------------------------------------------------------------------------------------
...
System.register("common/pubRequest", ["common/expiryCacheMap"], function (exports_39, context_39) {
    "use strict";
    var expiryCacheMap_2, PubRequest, pubRequest;
    var __moduleName = context_39 && context_39.id;
    return {
        setters: [
            function (expiryCacheMap_2_1) {
                expiryCacheMap_2 = expiryCacheMap_2_1;
            }
        ],
        execute: function () {
            PubRequest = /** @class */ (function () {
                function PubRequest() {
                    this.cache = new expiryCacheMap_2.ExpiryCacheMap();
                    this.headers = {
                        referer: "https://pub.dev/packages"
                    };
                }
                PubRequest.prototype.httpGet = function (packageName) {
                    return __awaiter(this, void 0, void 0, function () {
                        var url;
                        return __generator(this, function (_a) {
                            url = this.generatePubUrl(packageName);
                            try {
                                return [2 /*return*/, this.request("GET", packageName)];
                            }
                            catch (error) {
                                // handles any 404 errors during a request for the latest release
                                if (error.status === 404) {
                                    return [2 /*return*/, this.cache.set(url, null)];
                                }
                                // check if the request was not found and report back
                ...
                PubRequest.prototype.request = function (method, packageName) {
                    var _this = this;
                    var url = this.generatePubUrl(packageName);
                    var cacheKey = method + "_" + url;
                    if (this.cache.expired(url) === false) {
                        return Promise.resolve(this.cache.get(cacheKey));
                    }
                    var requestLight = require("request-light");
                    return requestLight
                        .xhr({ url: url, type: method, headers: this.headers })
                        .then(function (response) {
                        if (response && response.responseText) {
                            var value = JSON.parse(response.responseText);
                            _this.cache.set(cacheKey, value);
                            return Promise.resolve(value);
                        }
                        else {
                            return Promise.reject({
                                status: response.status,
                                data: _this.cache.set(cacheKey, null)
                            });
                        }
                    })
                        .catch(function (response) {
                ...
                PubRequest.prototype.generatePubUrl = function (packageName) {
                    return "https://pub.dev/api/documentation/" + packageName;
                };
                return PubRequest;
            }());
            exports_39("pubRequest", pubRequest = new PubRequest());
        }
    };
});
System.register("providers/pub/pubAPI", ["common/pubRequest"], function (exports_40, context_40) {
    "use strict";
    var pubRequest_1;
    var __moduleName = context_40 && context_40.id;
    function pubGetPackageInfo(packageName) {
        return new Promise(function (resolve, reject) {
            pubRequest_1.pubRequest
                .httpGet(packageName)
                .then(function (info) {
    ...
    exports_40("pubGetPackageInfo", pubGetPackageInfo);
    return {
        setters: [
            function (pubRequest_1_1) {
                pubRequest_1 = pubRequest_1_1;
            }
        ],
        execute: function () {
        }
...
System.register("providers/pub/pubPackageParser", ["common/packageGeneration"], function (exports_41, context_41) {
    "use strict";
    var PackageFactory, semver;
    var __moduleName = context_41 && context_41.id;
    // pubPackageParser(dependencyNodes: any[], appContrib: AppContribution, pubPackageParser: any) {
    //   throw new Error("Method not implemented.");
    // }
    function pubPackageParser(name, version, appContrib) {
    ...
    exports_41("pubPackageParser", pubPackageParser);
    return {
        setters: [
...
System.register("providers/pub/pubCodeLensProvider", ["providers/abstractCodeLensProvider", "common/appContrib", "common/codeLensGeneration", "common/appSettings", "providers/pub/pubDependencyParser", "commands/factory", "providers/pub/pubAPI", "providers/pub/pubPackageParser"], function (exports_42, context_42) {
    "use strict";
    var abstractCodeLensProvider_5, appContrib_10, codeLensGeneration_6, appSettings_12, pubDependencyParser_1, CommandFactory, pubAPI_1, pubPackageParser_1, PubCodeLensProvider;
    ...
    return {
        setters: [
            ...
            function (appContrib_10_1) {
                appContrib_10 = appContrib_10_1;
            },
            ...
            function (pubDependencyParser_1_1) {
                pubDependencyParser_1 = pubDependencyParser_1_1;
            },
            ...
            function (pubPackageParser_1_1) {
                pubPackageParser_1 = pubPackageParser_1_1;
            }
        ],
        execute: function () {
            PubCodeLensProvider = /** @class */ (function (_super) {
                __extends(PubCodeLensProvider, _super);
                function PubCodeLensProvider() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                Object.defineProperty(PubCodeLensProvider.prototype, "selector", {
                    get: function () {
                        return {
                            language: "yaml",
                            scheme: "file",
                ...
                PubCodeLensProvider.prototype.provideCodeLenses = function (document) {
                    if (appSettings_12.default.showVersionLenses === false) {
                        return;
                    }
                    var dependencyNodes = pubDependencyParser_1.findNodesInYamlContent(document, appContrib_10.default.pubDependencyProperties);
                    var packageCollection = pubDependencyParser_1.parseDependencyNodes(dependencyNodes, appContrib_10.default, pubPackageParser_1.pubPackageParser);
                    appSettings_12.default.inProgress = true;
                    return codeLensGeneration_6.generateCodeLenses(packageCollection, document).then(function (codelenses) {
                        appSettings_12.default.inProgress = false;
                        return codelenses;
                    });
                };
                PubCodeLensProvider.prototype.evaluateCodeLens = function (codeLens) {
                    if (codeLens.command &&
                    ...
                    return pubAPI_1.pubGetPackageInfo(codeLens.package.name)
                        .then(function (info) {
                        return CommandFactory.createVersionCommand(codeLens.package.version, info.latestStableVersion, codeLens);
                    })
                        .catch(function (err) {
                        console.error(err);
                ...
                return PubCodeLensProvider;
            }(abstractCodeLensProvider_5.AbstractCodeLensProvider));
            exports_42("PubCodeLensProvider", PubCodeLensProvider);
        }
    };
});
System.register("providers/codeLensProviders", ["providers/npm/npmCodeLensProvider", "providers/jspm/jspmCodeLensProvider", "providers/dub/dubCodeLensProvider", "providers/dotnet/dotnetCodeLensProvider", "providers/maven/mavenCodeLensProvider", "providers/pub/pubCodeLensProvider"], function (exports_43, context_43) {
    "use strict";
    var npmCodeLensProvider_2, jspmCodeLensProvider_1, dubCodeLensProvider_1, dotnetCodeLensProvider_1, mavenCodeLensProvider_1, pubCodeLensProvider_1, codeLensProviders;
    ...
    exports_43("getProvidersByFileName", getProvidersByFileName);
    ...
    exports_43("reloadActiveProviders", reloadActiveProviders);
    ...
    exports_43("reloadActiveProvidersByGroup", reloadActiveProvidersByGroup);
    return {
        setters: [
            ...
            function (pubCodeLensProvider_1_1) {
                pubCodeLensProvider_1 = pubCodeLensProvider_1_1;
            }
        ],
        execute: function () {
            codeLensProviders = [
                ...
                new pubCodeLensProvider_1.PubCodeLensProvider
            ];
            exports_43("default", codeLensProviders);
        }
    };
});
System.register("commands/editorIcons", ["common/appSettings", "editor/decorations", "providers/codeLensProviders"], function (exports_44, context_44) {
    "use strict";
    var appSettings_13, decorations_4, CodeLensProviders;
    var __moduleName = context_44 && context_44.id;
    function showTaggedVersions(file) {
        appSettings_13.default.showTaggedVersions = true;
        CodeLensProviders.reloadActiveProviders();
    }
    exports_44("showTaggedVersions", showTaggedVersions);
    function hideTaggedVersions(file) {
        appSettings_13.default.showTaggedVersions = false;
        CodeLensProviders.reloadActiveProviders();
    }
    exports_44("hideTaggedVersions", hideTaggedVersions);
    function showDependencyStatuses(file) {
        appSettings_13.default.showDependencyStatuses = true;
        CodeLensProviders.reloadActiveProviders();
    }
    exports_44("showDependencyStatuses", showDependencyStatuses);
    function hideDependencyStatuses(file) {
        appSettings_13.default.showDependencyStatuses = false;
        decorations_4.clearDecorations();
    }
    exports_44("hideDependencyStatuses", hideDependencyStatuses);
    function showVersionLenses(file) {
        appSettings_13.default.showVersionLenses = true;
        CodeLensProviders.reloadActiveProviders();
    }
    exports_44("showVersionLenses", showVersionLenses);
    function hideVersionLenses(file) {
        appSettings_13.default.showVersionLenses = false;
        CodeLensProviders.reloadActiveProviders();
    }
    exports_44("hideVersionLenses", hideVersionLenses);
    return {
        setters: [
...
System.register("commands/internal", [], function (exports_45, context_45) {
    "use strict";
    ...
    exports_45("updateDependencyCommand", updateDependencyCommand);
    ...
    exports_45("linkCommand", linkCommand);
    function showingProgress(file) {
        // currently do nothing
        // TODO attempt cancel?
    }
    exports_45("showingProgress", showingProgress);
    return {
        setters: [],
        execute: function () {
        }
...
System.register("commands/register", ["common/appSettings", "commands/editorIcons", "commands/internal"], function (exports_46, context_46) {
    "use strict";
    var appSettings_14, EditorIconsCommands, InternalCommands;
    var __moduleName = context_46 && context_46.id;
    function register() {
        var commands = require('vscode').commands;
        function mapCommand(commandName, index) {
            var mapObject = this;
            var id = appSettings_14.default.extensionName + "." + commandName;
...
System.register("editor/handlers", ["common/appSettings", "providers/codeLensProviders", "editor/decorations"], function (exports_47, context_47) {
    "use strict";
    var appSettings_15, codeLensProviders_1, decorations_5;
    var __moduleName = context_47 && context_47.id;
    function onActiveEditorChanged(editor) {
        if (!editor) {
            appSettings_15.default.isActive = false;
            return;
        }
        ...
        if (codeLensProviders_1.getProvidersByFileName(editor.document.fileName)) {
            appSettings_15.default.isActive = true;
            return;
        }
        appSettings_15.default.isActive = false;
    }
    exports_47("onActiveEditorChanged", onActiveEditorChanged);
    ...
    function onChangeTextDocument(changeEvent) {
        ...
        if (appSettings_15.default.isActive === false)
            return;
    ...
    exports_47("onChangeTextDocument", onChangeTextDocument);
    return {
        setters: [
...
System.register("editor/events", ["providers/codeLensProviders", "editor/handlers"], function (exports_48, context_48) {
    "use strict";
...
System.register("extension", ["commands/register", "providers/codeLensProviders", "editor/events"], function (exports_49, context_49) {
    "use strict";
