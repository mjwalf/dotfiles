...
function listSubscriptionsAsync(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return wizard_1.fromShellJson(sr);
    });
}
function setSubscriptionAsync(context, subscription) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return wizard_1.fromShellExitCodeAndStandardError(sr);
    });
}
...
function listLocations(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return wizard_1.fromShellJson(sr, (response) => {
...
function listAcsLocations(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return wizard_1.fromShellJson(sr, (response) => locationDisplayNamesEx(response.productionRegions, response.previewRegions, locations));
    });
}
...
function listVMSizes(context, location) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return wizard_1.fromShellJson(sr, (response) => response.map((r) => r.name)
