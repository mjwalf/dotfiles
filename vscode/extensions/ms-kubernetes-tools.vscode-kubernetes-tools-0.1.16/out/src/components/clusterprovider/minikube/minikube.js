...
function minikubeUpgradeAvailable(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (currentVersion !== availableVersion) {
            vscode.window.showInformationMessage(`Minikube upgrade available to ${availableVersion}, currently on ${currentVersion}`, 'Install').then((value) => __awaiter(this, void 0, void 0, function* () {
                if (value === 'Install') {
