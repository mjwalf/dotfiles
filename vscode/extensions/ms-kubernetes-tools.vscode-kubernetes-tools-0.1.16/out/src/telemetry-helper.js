...
function telemetrise(command, kubectl, callback) {
    return (a) => {
        clusterType(kubectl).then((ct) => telemetry_1.reporter.sendTelemetryEvent("command", { command: command, clusterType: ct }));
        return callback(a);
    };
}
...
function loadCachedClusterType(kubectl) {
    return __awaiter(this, void 0, void 0, function* () {
        if (latestContextName && knownClusters[latestContextName]) {
            ...
            cachedClusterType = yield inferCurrentClusterType(kubectl, latestContextName);
...
function inferCurrentClusterType(kubectl, contextNameHint) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!latestContextName) {
