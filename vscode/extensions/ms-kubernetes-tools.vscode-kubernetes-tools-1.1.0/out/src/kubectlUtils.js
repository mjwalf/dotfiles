...
function namespaceResources(kubectl, ns) {
    return __awaiter(this, void 0, void 0, function* () {
        const arresult = yield kubectl.fromLines('api-resources -o wide');
        if (errorable_1.failed(arresult)) {
            return arresult;
        }
        ...
        const getresult = yield kubectl.invokeAsync(`get ${resourceKindsList} -o name --namespace ${ns} --ignore-not-found`);
