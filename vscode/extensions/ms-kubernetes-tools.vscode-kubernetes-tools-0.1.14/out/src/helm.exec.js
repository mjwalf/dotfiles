...
function helmFetchCore(chartId, version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (sr.code !== 0) {
            yield vscode.window.showErrorMessage(`Helm fetch failed: ${sr.stderr}`);
            return;
        }
...
function helmInstallCore(kubectl, chartId, version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (sr.code !== 0) {
            logger_1.helm.log(sr.stderr);
            yield vscode.window.showErrorMessage(`Helm install failed: ${sr.stderr}`);
            return;
        }
...
function helmDependenciesLaunchViewer(chartId, version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield vscode.commands.executeCommand("vscode.previewHtml", uri, vscode.ViewColumn.Two, `${chartId} Dependencies`);
    });
}
...
function helmExec(args, fn) {
    ...
    const configuredBin = vscode.workspace.getConfiguration('vs-kubernetes')['vs-kubernetes.helm-path'];
