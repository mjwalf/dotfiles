...
class DebugSession {
    ...
    launch(workspaceFolder, debugProvider) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (debugProvider) {
                this.debugProvider = (yield debugProvider.isDebuggerInstalled()) ? debugProvider : null;
            }
            else {
            ...
            vscode.window.withProgress({ location: vscode.ProgressLocation.Window }, (p) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    appName = yield this.runAsDeployment(imageName, [portInfo.appPort, portInfo.debugPort], containerEnv);
    ...
    attach(workspaceFolder, pod, podNamespace) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let targetPod = pod, targetPodNS = podNamespace, targetContainer = undefined, containers = [];
            const resource = pod ?
                yield kubectlUtils.getResourceAsJson(this.kubectl, `pod/${pod}`, podNamespace) :
                yield kubectlUtils.getResourceAsJson(this.kubectl, "pods");
            if (!resource) {
                return;
            }
            if (kuberesources_objectmodel_1.isPod(resource)) {
            ...
            vscode.window.withProgress({ location: vscode.ProgressLocation.Window }, (p) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    // Start debug session.
                    p.report({ message: `Starting ${this.debugProvider.getDebuggerType()} debug session...` });
                    yield this.startDebugSession(null, workspaceFolder.uri.fsPath, proxyResult);
                }
                catch (error) {
                    vscode.window.showErrorMessage(error);
                    kubeChannel_1.kubeChannel.showOutput(`Debug on Kubernetes failed. The errors were: ${error}.`);
    ...
    pickupAndInstallDebugProvider(baseImage) {
        return __awaiter(this, void 0, void 0, function* () {
            const debugProvider = yield providerRegistry.getDebugProvider();
            if (!debugProvider) {
                return;
            }
    ...
    buildDockerImage(imagePrefix, shellOpts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const imageName = yield dockerUtils.buildAndPushDockerImage(dockerUtils.DockerClient.docker, shellOpts, imagePrefix);
    ...
    promptForCleanup(resourceId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (answer === "Clean Up") {
                ...
                const globalConfig = Object.assign({}, oldConfig.globalValue);
                globalConfig["vs-kubernetes.autoCleanupOnDebugTerminate"] = true;
                yield vscode.workspace.getConfiguration().update("vs-kubernetes", globalConfig, vscode.ConfigurationTarget.Global);
                ...
                if (oldConfig.workspaceFolderValue && oldConfig.workspaceFolderValue["vs-kubernetes.autoCleanupOnDebugTerminate"] === false) {
                    const workspaceFolderConfig = Object.assign({}, oldConfig.workspaceFolderValue);
                    workspaceFolderConfig["vs-kubernetes.autoCleanupOnDebugTerminate"] = true;
                    yield vscode.workspace.getConfiguration().update("vs-kubernetes", workspaceFolderConfig, vscode.ConfigurationTarget.WorkspaceFolder);
                }
                else if (oldConfig.workspaceValue && oldConfig.workspaceValue["vs-kubernetes.autoCleanupOnDebugTerminate"] === false) {
                    const workspaceConfig = Object.assign({}, oldConfig.workspaceValue);
                    workspaceConfig["vs-kubernetes.autoCleanupOnDebugTerminate"] = true;
                    yield vscode.workspace.getConfiguration().update("vs-kubernetes", workspaceConfig, vscode.ConfigurationTarget.Workspace);
                }
                return yield this.cleanupResource(resourceId);
            }
        });
    ...
    cleanupResource(resourceId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (deleteResult.code !== 0) {
                kubeChannel_1.kubeChannel.showOutput(`Kubectl command failed: ${deleteResult.stderr}`);
                return;
            }
            else {
    ...
    waitForProxyReady(proxyProcess) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                proxyProcess.on('close', (code) => __awaiter(this, void 0, void 0, function* () {
                    if (!isProxyReady) {
