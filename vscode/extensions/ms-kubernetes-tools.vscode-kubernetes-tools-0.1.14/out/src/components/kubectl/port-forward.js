...
function portForwardKubernetes(kubectl, explorerNode) {
    return __awaiter(this, void 0, void 0, function* () {
        if (explorerNode) {
            ...
            const portMapping = yield promptForPort();
...
function portForwardToPod(kubectl, podName, portMapping, namespace) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        usedPortMappings.forEach((usedPortPair) => {
            host_1.host.showInformationMessage(`Forwarding from 127.0.0.1:${usedPortPair.localPort} -> ${podName}:${usedPortPair.targetPort}`);
        });
